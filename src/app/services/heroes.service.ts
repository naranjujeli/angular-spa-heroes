...
export class HeroesService {
    ...
    private heroes: Hero[] = [
        ...
        },
        {
            ...
            img: "/assets/images/green-lantern.png",
        ...
        },
        {
            ...
            img: "/assets/images/spider-man.png",
    ...
    searchHero( term: string ) : Hero[] {
        let searchResults : Hero[] = [];
        term = term.toLowerCase();

        for (let hero of this.heroes) {
            let name = hero.name.toLowerCase();
            if (name.indexOf(term) >= 0) { // Una coincidencia fue hallada
                searchResults.push(hero);
            }
        }
